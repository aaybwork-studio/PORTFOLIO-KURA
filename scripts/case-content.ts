    ...
    sections: [
      {
        ...
        note: "React and Three.js in front, FastAPI, ChromaDB and Ollama behind, plus a React Native companion that captures on the move and syncs when a connection returns.",
      },
      {
        kicker: "Process",
    ...
    sections: [
      {
        ...
        note: "Built with Armaan Hawes. Camera, touch and voice, each carrying the part of the job it is actually good at.",
      },
      {
        kicker: "Process",
    ...
    sections: [
      {
        ...
        note: "Unity 6 for the MR scene, Blender for geometry, Figma for the interface, and a build people could put on and play rather than a video of one.",
      },
      {
        kicker: "Process",
