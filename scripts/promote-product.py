...
PROMOTE = {
    "orbit": {
        "hero2": ("hero.jpg", HERO),
        "p-spaces": ("spaces.jpg", HALF), "p-history": ("history.jpg", HALF),
        "p-overlay": ("overlay.jpg", HALF), "p-companion": ("companion.jpg", HALF),
        "m-detail": ("m-detail.jpg", HALF), "m-flatlay": ("m-flatlay.jpg", HALF),
        "m-lineup": ("m-lineup.jpg", FULL), "m-devices": ("m-devices.jpg", FULL),
        "m-array": ("m-array.jpg", FULL), "m-desk": ("m-desk.jpg", FULL),
    },
    "queue": {
        "p-hero": ("hero.jpg", HERO),
        "p-tryon": ("tryon.jpg", HALF), "p-compare": ("compare.jpg", HALF),
        "p-analysis": ("analysis-panel.jpg", HALF), "p-stylist": ("stylist.jpg", HALF),
        "m-detail": ("m-detail.jpg", HALF), "m-held": ("m-held.jpg", HALF),
        "m-lineup": ("m-lineup.jpg", FULL), "m-devices": ("m-devices.jpg", FULL),
        "m-array": ("m-array.jpg", FULL), "m-counter": ("m-counter.jpg", FULL),
    },
    "memory-bank": {
        "p-hero": ("hero.jpg", HERO),
        "p-library": ("library.jpg", HALF), "p-memory": ("memory.jpg", HALF),
        "p-capture": ("capture.jpg", HALF), "p-save": ("save.jpg", HALF),
        "m-detail": ("m-detail.jpg", HALF), "m-prints": ("m-prints.jpg", HALF),
        "m-lineup": ("m-lineup.jpg", FULL), "m-array": ("m-array.jpg", FULL),
        "m-flatlay": ("m-flatlay.jpg", FULL), "m-street": ("m-street.jpg", FULL),
    },
    "guitar-flow": {
        "p-hero": ("headset.jpg", HERO),
        "p-menu": ("menu.jpg", HALF), "p-workspace": ("unity-2.jpg", HALF),
        "p-lesson": ("lesson.jpg", HALF), "p-play": ("play.jpg", HALF),
        "m-detail": ("m-detail.jpg", HALF), "m-room": ("m-room.jpg", HALF),
        "m-lineup": ("m-lineup.jpg", FULL), "m-devices": ("m-devices.jpg", FULL),
        "m-array": ("m-array.jpg", FULL), "m-close": ("m-close.jpg", FULL),
    },
    "navaid": {
        # The full-chair shot never resolved: at that distance the mounted tablet
        # is small enough that the model kept inventing an oversized screen. The
        # hero moves in close on the control unit instead.
        "m-hero": ("hero-screen.jpg", HERO),
        "p-outdoors": ("outdoors.jpg", HALF), "p-manual": ("manual.jpg", HALF),
        "p-location": ("location.jpg", HALF), "m-detail": ("m-detail.jpg", HALF),
        "m-joystick": ("m-joystick.jpg", HALF), "m-mount": ("m-mount.jpg", HALF),
        "m-lineup": ("m-lineup.jpg", FULL), "p-add-chair": ("add-chair.jpg", FULL),
        "m-seated": ("m-seated.jpg", FULL), "m-caretaker": ("m-caretaker.jpg", FULL),
    },
}
